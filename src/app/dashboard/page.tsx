      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {!loading && (
          <section>
            ...
            {/* Main Feature Chart - Marketing Cost */}
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                    ...
                    Marketing Cost vs Sales by Team
                  </h3>
                  <p className="text-sm text-gray-600">Comparison of marketing investment and returns</p>
                </div>
              </div>
              <div className="h-80">
                <MarketingCostChart marketingData={marketing} orderData={orders} />
              </div>
            </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="p-6">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-gray-600">Lead sources by team</p>
                </div>
                <div className="h-80">
                  <LeadSourcesChart marketingData={marketing} />
                </div>
              </Card>
              ...
              <Card className="p-6">
                ...
                <div className="h-80">
                  <TopPerformersChart orderData={orders} />
                </div>
              </Card>
            </div>
          </section>
